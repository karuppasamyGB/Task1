...
//                 header("Location: create_blog_page.php");
//                 exit;
//             } else {
...
// Simulating user login (in a real scenario, you would validate user credentials)
// session_start();
// include '../models/db_config.php'; 
// if ($_SERVER['REQUEST_METHOD'] === 'POST') {
//     // Simulating login using hardcoded credentials
...
//         // Redirect or handle any post-login logic here if needed
//     } else {
//         $username = trim($_POST['username']);
//         $password = trim($_POST['password']);
...
//                     $_SESSION['username'] = $db_username;
//                     session_regenerate_id(true);
//                     header("Location: /Simple%20web/views/create_blog_page.php");
//                     exit;
//                 } else {
//                     $error = "Incorrect password!";
//                 }
